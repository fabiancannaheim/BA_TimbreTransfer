...
trained_checkpoint_prefix = '../../../models/spleeter/pretrained_models/4stems/model'
...
with tf.compat.v1.Session(graph=graph) as sess:
    ...
    drums_tensor = tf.compat.v1.get_default_graph().get_tensor_by_name("strided_slice_43:0")
